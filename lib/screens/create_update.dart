...
class CreateUpdateDialog extends HookConsumerWidget {
  final Product product;
  final bool create;
  const CreateUpdateDialog(
      {Key? key, required this.product, required this.create})
      : super(key: key);
  @override
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              initialValue: product.buy_price.toString(),
                              onChanged: (e) {
                                product.buy_price =
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              initialValue: product.sell_price.toString(),
                              onChanged: (e) {
                                product.sell_price =
                                    e == "" ? 0 : double.parse(e.toString());
                              },
